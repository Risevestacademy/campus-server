...
CREATE TYPE "public"."student_status" AS ENUM('active', 'dismissed', 'graduated', 'withdrawn', 'deferred');--> statement-breakpoint
...
CREATE TABLE "cohort_members" (
	...
	CONSTRAINT "cohort_members_student_status" CHECK ("cohort_members"."role" = 'student' or "cohort_members"."status" is null)
);
...
CREATE TABLE "invites" (
	...
	CONSTRAINT "invites_cohort_pairing" CHECK (("invites"."cohort_id" is null) = ("invites"."cohort_role" is null)),
	CONSTRAINT "invites_scoped_fields_require_cohort" CHECK ("invites"."cohort_id" is not null or ("invites"."cohort_track_id" is null and "invites"."mentorship_group_id" is null)),
...
CREATE UNIQUE INDEX "cohort_members_unique" ON "cohort_members" USING btree ("cohort_id","user_id");--> statement-breakpoint
